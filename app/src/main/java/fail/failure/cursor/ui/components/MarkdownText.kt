    ...
    Column(modifier = modifier, verticalArrangement = Arrangement.spacedBy(6.dp)) {
        ...
        fun flushCode() {
            ...
            Text(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .background(CursorSurfaceRaised, RoundedCornerShape(8.dp))
                    .padding(10.dp),
            )
        }
        ...
        markdown.lineSequence().forEach { rawLine ->
            ...
            when {
                ...
                line.trimStart().let { it.startsWith("- ") || it.startsWith("* ") } -> {
                    Row {
                        Text("•  ", color = CursorAccent, style = MaterialTheme.typography.bodyLarge)
                ...
                Regex("^\\d+\\.\\s").containsMatchIn(line.trimStart()) -> {
                    ...
                    Row {
                        Text(marker, color = CursorAccent, style = MaterialTheme.typography.bodyLarge)
