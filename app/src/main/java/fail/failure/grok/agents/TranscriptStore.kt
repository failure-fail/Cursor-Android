...
/** Mirrors [fail.failure.grok.ui.agents.TranscriptLine] for storage - kept separate so the
...
/**
 * Persists each agent's observed transcript locally. Grok's API has no endpoint to fetch a
